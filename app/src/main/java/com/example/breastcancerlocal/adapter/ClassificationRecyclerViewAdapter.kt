...
class ClassificationRecyclerViewAdapter(items: List<BreastCancerVO>, listener: ListFragment.OnListFragmentInteractionListener)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.listClassificationthreeView.text = " " + mValues[position].getBmi() + " "
        holder.listClassificationfourView.text = " " + mValues[position].getGlucose() + " "
        holder.listClassificationfiveView.text = " " + mValues[position].getInsulin() + " "
        holder.listClassificationsixView.text = " " + mValues[position].getHoma() + " "
        holder.listClassificationsevenView.text = " " + mValues[position].getLeptin() + " "
        holder.listClassificationeightView.text = " " + mValues[position].getAdiponectin() + " "
        holder.listClassificationnineView.text = " " + mValues[position].getResistin() + " "
        holder.listClassificationtenView.text = " " + mValues[position].getMcp() + " "
