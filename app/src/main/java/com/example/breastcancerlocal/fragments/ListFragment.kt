...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        ...
        model = BreastCancerViewModel.getInstance(myContext)
    ...
    override fun onResume() {
        super.onResume()
            (root as RecyclerView).adapter = ClassificationRecyclerViewAdapter(model.listBreastCancer(), mListener!!)
    }
    ...
    interface OnListFragmentInteractionListener {
        fun onListFragmentInteraction(item: BreastCancerVO)
    }
}
