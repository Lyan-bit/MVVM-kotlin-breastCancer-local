...
class ClassificationsViewModel (context: Context): ViewModel() {

    private val assetManager: AssetManager = context.assets
    private val crudViewModel = BreastCancerViewModel.getInstance(context)

    companion object {
        private var instance: ClassificationsViewModel? = null
        fun getInstance(context: Context): ClassificationsViewModel {
            return instance ?: ClassificationsViewModel(context)
        }
    }
    ...
    fun classify(classification: BreastCancer) : String {
        var res : String
        ...
        crudViewModel.editBreastCancer(BreastCancerVO( classification))
